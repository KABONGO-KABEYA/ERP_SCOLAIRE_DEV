...
using SchoolManagement.Application.Bulletins.Services;
using SchoolManagement.Application.Mentions.Interfaces;
using SchoolManagement.Application.Mentions.Services;
using SchoolManagement.Application.Deliberation.Interfaces;
using SchoolManagement.Application.Deliberation.Services;
using SchoolManagement.Application.ResultValidation.Interfaces;
using SchoolManagement.Application.ResultValidation.Services;
...
public static class ApplicationServiceRegistration
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<IResultCalculationEngine, ResultCalculationEngine>();
        services.AddScoped<IResultCalculationService, ResultCalculationService>();
        services.AddScoped<IBulletinQueryService, BulletinQueryService>();
        services.AddScoped<IResultValidationService, ResultValidationService>();
        services.AddScoped<IDeliberationService, DeliberationService>();
        services.AddScoped<IResultMentionService, ResultMentionService>();
