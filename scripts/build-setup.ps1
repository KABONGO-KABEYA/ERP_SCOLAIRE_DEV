...
$readmeLines = @(
  'ERP Scolaire - Package d installation CLIENT / ECOLE',
  '====================================================',
  '',
  $runtimeNote,
  $versionNote,
  ...
  'IMPORTANT',
  '---------',
  '- Copiez TOUT le dossier (Setup + payload\) sur la machine cible.',
  '- Lancez ErpScolaire.Setup.exe en Administrateur.',
  '- Ne pas lancer uniquement SchoolManagement.Desktop.exe depuis payload\.',
  '',
  'A. INSTALLATION SERVEUR ECOLE (1 seule machine)',
  '-----------------------------------------------',
  'Pre-requis :',
  '  - Windows 10/11/Server + droits Admin',
  '  - SQL Server Express (ou +) deja installe',
  '  - Ports 5096 et 5041 libres',
  '  - Acces Internet vers Cloud API (169.58.93.203:1804) et Bootstrap',
  '  - Disque pour dossiers eleves (ex. D:\ERP_SCOLAIRE)',
  '',
  'Etapes assistant :',
  '  1) Type = Installation Serveur',
  '  2) SQL local -> Tester (obligatoire)',
  '  3) SQL Cloud -> Tester (si sync activee)',
  '  4) Dossier fichiers -> Tester',
  '  5) Terminer',
  '',
  'Apres installation :',
  '  - Service Windows ErpScolaireApi = Running',
  '  - Health : http://127.0.0.1:5096/api/v1/health',
  '  - Desktop ouvre l assistant initial (ecole + annee + admin + frais)',
  '  - Verifier QR etablissement / sync Bootstrap (Synced)',
  '  - Sauvegarder ServerIdentity.json AVEC la base SQL',
  '',
  'B. INSTALLATION POSTE CLIENT (autres PC du bureau)',
  '--------------------------------------------------',
  'Pre-requis : meme reseau LAN que le serveur ecole.',
  'Etapes :',
  '  1) Type = Installation Poste Client',
  '  2) URL API = http://IP-DU-SERVEUR:5096',
  '  3) Terminer -> Desktop seulement (pas de SQL local)',
  '',
  'C. CONTROLES FINAUX',
  '-------------------',
  '  - Connexion admin creee a l assistant initial',
  '  - Classes / frais / eleves / paiements OK',
  '  - Mobile : scanner QR etablissement puis login',
  '',
